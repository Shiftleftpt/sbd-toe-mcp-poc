# Eixo I — LEITURAS vs oráculo do lead — 2026-09-06 — @shiftleftpt/sbd-toe-mcp@0.20.0-beta.37
...
Bundle servido: KG `kg-v1-manual-v1.8.1-aligned-2026-09-06`.
...
| Peça do must-have | Servida | Evidência |
|---|---|---|
| arranque barato (quick-start) | sim | 585 tk |
