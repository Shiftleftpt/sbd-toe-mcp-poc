...
**Beta line:** v0.20.0-beta.26 → `b1ab9a73fb862f88db1ed4233f58ff00937a67c3` (2026-09-06; `release.yml` run 34026770992 publicou npm `@shiftleftpt/sbd-toe-mcp@0.20.0-beta.26` = `beta`, gitHead igual; GitHub pre-release) fecha a
