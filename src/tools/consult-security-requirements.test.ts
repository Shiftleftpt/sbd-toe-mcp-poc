...
function makeOntologyData(overrides: Partial<OntologyData> = {}): OntologyData {
  return {
    ...
    controls: [
      { control_id: "CTRL-001", name: "Identity Control", domain: "identity", control_type: "preventive", abstraction_level: "technical", applicable_lifecycle_phases: ["design"] },
      { control_id: "CTRL-002", name: "Monitoring Control", domain: "monitoring", control_type: "detective", abstraction_level: "operational", applicable_lifecycle_phases: ["operate"] },
      { control_id: "CTRL-003", name: "Code Integrity Control", domain: "code_integrity", control_type: "preventive", abstraction_level: "technical", applicable_lifecycle_phases: ["develop"] },
      { control_id: "CTRL-004", name: "Governance Control", domain: "governance", control_type: "preventive", abstraction_level: "strategic", applicable_lifecycle_phases: ["design"] },
    ],
    roles: [],
    threats: [],
    assignments: [],
